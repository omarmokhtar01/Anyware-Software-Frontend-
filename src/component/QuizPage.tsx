...
import AddQuiztHook from '../hook/quiz/add-quiz-hook';
...
export default function Dashnew() {
    ...
    const [title, loading, onSubmit, onChangeTitle, topic, onChangeTopic, dueTo, onChangeDueTo] = AddQuiztHook()
    return (
                                    ...
                                    <Grid container>
                                        ...
                                        <Grid item xs={12} sm={8}>
                                            ...
                                            >
                                                <TextField
                                                    value={title}
                                                    onChange={onChangeTitle as React.ChangeEventHandler<HTMLInputElement>}
                                                    placeholder="Enter Title"
                                                    style={{ width: '100%', outline: 'none', border: '2px solid #33BBC5', borderRadius: '10px', fontStyle: 'normal' }}
                                                />

                                                <TextField
                                                    value={topic}
                                                    onChange={onChangeTopic as React.ChangeEventHandler<HTMLInputElement>}
                                                    placeholder="topic"
                                                    style={{ width: '100%', outline: 'none', border: '2px solid #33BBC5', borderRadius: '10px', marginTop: '10px', fontStyle: 'normal' }}
                                                />

                                                <TextField
                                                    value={dueTo}
                                                    onChange={onChangeDueTo as React.ChangeEventHandler<HTMLInputElement>}
                                                    placeholder="dueTo"
                                                    style={{ width: '100%', outline: 'none', border: '2px solid #33BBC5', borderRadius: '10px', marginTop: '10px', fontStyle: 'normal' }}
                                                />
